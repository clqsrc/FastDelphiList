...
//解码请求
//http 的 range 头是从 0 开始的,并且 range: 1024-1024/2048 是要取 1024 这个位置的一个字节的//所以结束位置是要减去 1 的
procedure DecodeRange(s:string; var rangeBegin:Integer; var rangeEnd:Integer);
var
  sl:TStringList;
  fLine:string;
