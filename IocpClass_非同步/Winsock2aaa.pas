...
function bind(const s: TSocket; const addr: TSockAddr; const namelen: Integer): Integer; stdcall;
function closesocket(const s: TSocket): Integer; stdcall;
function connect(const s: TSocket; const name: TSockAddr; namelen: Integer): Integer; stdcall;
...
function WSAAccept(s: TSocket; var addr: TSockAddr; addrlen: PInteger; lpfnCondition: LPCONDITIONPROC; dwCallbackData: DWORD): TSocket; stdcall;
...
var
  len                              : Integer;
begin
  if snb <> nil then with snb^ do begin
