...
type
  u_char = Char;
  u_short = Word;
  u_int = Integer;//Cardinal;//clq//Integer;
  u_long = Longint;
  pu_long = ^u_long;
  pu_short = ^u_short;
...
{ The new type to be used in all
  ...
  TSocket = Cardinal;//Integer;//Cardinal;//clq//u_int;//c ÓïÑÔÔ­ÐÍÀïµÄÈ·ÊÇÎÞ·ûºÅµÄ
...
type
  ...
  //PSockAddr = ^TSockAddr;
  //SOCKADDR = TSockAddrIn;//TSockAddr;
...
{ Other NT-specific options. }
  ...
  SO_MAXDG        = $7009;
  SO_MAXPATHDG    = $700A;
  SO_UPDATE_ACCEPT_CONTEXT         = $700B;//clq
  SO_CONNECT_TIME                  = $700C;//clq
...
//clq Îª¼æÈÝÆäËû°æ±¾µÄ WinSock2, ²»¹ýÏó IdWinSock2 Ò²²»È«ÊÇÕýÈ·µÄ,±ÈÈçËüµÄ TSocket ÉèÎª integer Ó¦¸ÃÊÇ²»¶ÔµÄ,Ó¦µ±ÊÇÎÞ·ûºÅ
...
//    lpCompletionRoutine: PWSAOVERLAPPED_COMPLETION_ROUTINE): integer{u_int}; stdcall;
...
//clq
function AcceptEx; external MSWSOCK_DLL name 'AcceptEx';
...
//clqfunction TransmitFile; external winsocket name 'TransmitFile';
function TransmitFile; external MSWSOCK_DLL name 'TransmitFile';
